        ...
        <div className="flex flex-col items-center gap-4 py-8">
          ...
          {isSpeaking && (
            <Button
              ...
              variant="outline"
              size="sm"
              className="rounded-xl gap-2 text-xs border-surface-200 animate-fade-in"
            >
            ...
            {history.map((item) => (
              <div key={item.id} className="bg-white rounded-2xl border border-surface-200 shadow-card overflow-hidden">
                ...
                <div className="px-4 py-3 flex items-start gap-2">
                  ...
                  <p className="text-xs text-slate-600 leading-relaxed line-clamp-4">{item.answer.replace(/[#*`]/g, "")}</p>
                </div>
